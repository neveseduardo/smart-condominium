        ...
        password: [{
          ...
          validator: function validator(rule, value, callback) {
            if (value === '') {
              ...
              callback(new Error('A senha não pode ser menor que 4 caracteres.'));
            } else {
              callback();
            }
          }
    ...
    handleLogin: function handleLogin() {
      ...
      this.$refs.loginForm.validate( /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(valid) {
          var requestLogin, data, req, user;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _this.loading = true;
                  Object(function webpackMissingModule() { var e = new Error("Cannot find module 'nprogress'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
                  requestLogin = _http__WEBPACK_IMPORTED_MODULE_1__.default.authentication.login;
                ...
                case 8:
                  req = _context.sent;
                  user = req.data.user;
                  (0,_services_authentication__WEBPACK_IMPORTED_MODULE_2__.login)(user);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var domain = 'https://condominiumn.herokuapp.com/api';
...
/* harmony import */ var _environments__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/environments */ "./resources/js/environments.js");
/* harmony import */ var _services_authentication__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/services/authentication */ "./resources/js/services/authentication.js");
...
var http = axios__WEBPACK_IMPORTED_MODULE_0___default().create({
  baseURL: _environments__WEBPACK_IMPORTED_MODULE_1__.default.domain,
  timeout: 60000
});
http.interceptors.request.use(function (config) {
  var user = (0,_services_authentication__WEBPACK_IMPORTED_MODULE_2__.isLogged)();
...
http.interceptors.response.use(function (res) {
  ...
  if (method === 'post' && "development" === 'production') {
    console.log(res);
  }
  ...
  if (parseInt(response.status) === 401 && user !== undefined) {
    (0,_services_authentication__WEBPACK_IMPORTED_MODULE_2__.logout)();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  login: function login(data) {
    return _http_interceptor__WEBPACK_IMPORTED_MODULE_0__.default.post('/auth/login', data);
  }
});
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Auth/Login.vue?vue&type=style&index=0&lang=scss&":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Auth/Login.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _Login_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Login.vue?vue&type=style&index=0&lang=scss& */ "./resources/js/views/Auth/Login.vue?vue&type=style&index=0&lang=scss&");
...
/***/ "./resources/js/views/Auth/Login.vue?vue&type=style&index=0&lang=scss&":
/*!*****************************************************************************!*\
  !*** ./resources/js/views/Auth/Login.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
